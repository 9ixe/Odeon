...
//       
//       Command:
//           LottieGen -GenerateColorBindings -GenerateDependencyObject -Language CSharp -MinimumUapVersion 8 -Namespace Odeon.Animations -Public -WinUIVersion 2.8 -InputFile AnimatedPlayingVisualSource.json
//       
//       Input file:
...
namespace Odeon.Animations
{
        ...
        , Microsoft.UI.Xaml.Controls.IAnimatedVisualSource2
    {
        ...
        internal static readonly Color c_themeColor_FFFFFF = Color.FromArgb(0xFF, 0xE8, 0x11, 0x23);
        ...
        public static readonly DependencyProperty Color_FFFFFFProperty =
            DependencyProperty.Register("Color_FFFFFF", typeof(Color), typeof(AnimatedPlayingVisualSource),
                new PropertyMetadata(c_themeColor_FFFFFF, OnColor_FFFFFFChanged));
        ...
        private static Color GetCurrentAccentColor()
        {
            try
            {
                if (Application.Current?.Resources?.TryGetValue("SystemAccentColor", out object val) == true && val is Color c)
                {
                    return c;
                }
            }
        ...
        static void OnColor_FFFFFFChanged(DependencyObject d, DependencyPropertyChangedEventArgs args)
        {
            ...
            {
                ((AnimatedPlayingVisualSource)d)._themeProperties?.InsertVector4("Color_FFFFFF", ColorAsVector4(color));
            }
        }
        ...
        CompositionPropertySet EnsureThemeProperties(Compositor compositor)
        {
            if (_themeProperties == null)
            {
                ...
                if (color == default || color == Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF))
                {
                    color = GetCurrentAccentColor();
                }
                _themeProperties.InsertVector4("Color_FFFFFF", ColorAsVector4(color));
            }
